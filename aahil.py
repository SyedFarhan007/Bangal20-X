...
##### LOGO #####
logo = """
\033[1;92m❦ ═════════════ •⊰❂⊱• ═════════════ ❦  \033[1;98mWELCOME TO TECH-ABM  ⨂
\033[1;92m❦ ═════════════ •⊰❂⊱• ═════════════ ❦  \033[1;98mBANGLADESH CLONING COMMNADS  ⨂
\033[1;92m❦ ═════════════ •⊰❂⊱• ═════════════ ❦  \033[1;98mANONYMOUSLY DARK FATE    ⨂
\033[1;92m❦ ═════════════ •⊰❂⊱• ═════════════ ❦  \033[1;98mWE ARE DARK NIGHT LEGEND   ⨂

\033[1;96m❋❈╭┳✪✪╤────────────────────────➛➢
\033[1;96m⩩⩩║\033[1;92mGITHUB : https://github.com/Tech-abm
\033[1;96m⩩⩩║\033[1;92mINSTAGRAM : T4bm975
\033[1;96m⩩⩩║\033[1;92mFACEBOOK : Abdulbasit558
\033[1;96m⩩⩩║\033[1;92mOWNER : TECH-ABM
\033[1;96m❋❈╰┻✪✪╧────────────────────────➛➢
"""

jalan("\033[1;26m⚞⚌⚟ ASSALAM-O-ALIKUM ⚞⚌⚟ ")
jalan("\033[1;26m⚞⚌⚟ BANGLADESH CLONING COMMNAD ⚞⚌⚟ ") 
jalan("\033[1;26m⚞⚌⚟ STAY HOME AND STAY LIVE ⚞⚌⚟ ") 
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
os.system("clear")
print  """
\033[1;91m___ ____ ___
\033[1;91m____(   \              .-'    `-.              /   )____
\033[1;91m(____     \_____       /  (O  O)  \       _____/     ____)
\033[1;91m(____            `-----(      )     )-----'            ____)
\033[1;91m(____     _____________\  \____/  /_____________     ____) 
\033[1;91m(______/              `-.____.-'              \______)  
\033[1;89m   ⩩⩩ BANGLADESHI COUNTRY COMMNAD ⩩⩩
\033[1;91m⸎❋⸎▇▇▇▇▇▇▇▇▇▇▇▇⸎❋⸎\033[1;96m⟢⟣\033[1;91m⸎❋⸎▇▇▇▇▇▇▇▇▇▇▇▇▇⸎❋⸎"""
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
    	password = raw_input("\033[1;96m[⸎] \x1b[1;96mPASSWORD \x1b[1;96m>>>> ")
        if (password == CorrectPassword):
            print "Logged in successfully as " + username
            loop = 'false'
        else:
            print "Wrong Password"
            os.system('xdg-open https://www.facebook.com/Abdulbasit558')
    else:
...
def login():
	...
	try:
		...
		print logo
		print 42*"\033[1;96m="
		print('\033[1;96m[☆] \x1b[1;96mUse a fresh account to login \x1b[1;96m[☆]' )
...
def pilih_super():
	...
	if peak =="":
		...
		try:
			...
			print"\033[1;31;98m[▇▇] Name : "+op["name"]
		except KeyError:
			print"\x1b[1;92m[▇▇] ID Not Found!"
			raw_input("\n\033[1;96m[\033[1;94mBack\033[1;96m]")
			super()
		print"\033[1;35;98m[▇▇] Getting IDs..."
	...
	print "\033[1;36;92m[▇▇] Total IDs : \033[1;94m"+str(len(id))
	jalan('\033[1;34;40m[✺] Please Wait...')
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\033[1;32;92m[▇▇] Cloning\033[1;93m"+o),;sys.stdout.flush();time.sleep(1)
	print "\n\033[1;94m        ❈     \x1b[1;31mTo Stop Process Press CTRL+Z \033[1;94m    ❈"
	print " \033[1;31;40m●✪════════════════════════⸎✪⸎════════════════════════✪●"

	jalan('             \033[1;98mPLEASE WAITING FOR CLONING...')
	print  "\033[1;36;40m ●✪════════════════════════⸎✪⸎════════════════════════✪●" 
